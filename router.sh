...
if [ ! "sudo systemctl list-units --type=service | grep 'dhcpcd.service'" ]; then sudo systemctl stop dhcpcd.service && sudo systemctl disable dhcpcd.service; fi
if [ ! "sudo systemctl list-units --type=service | grep 'isc-dhcp-server.service'" ]; then sudo systemctl enable isc-dhcp-server.service; fi
